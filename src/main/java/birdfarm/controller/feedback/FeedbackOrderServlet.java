 ...
 * @author ASUS
 */
@WebServlet(name = "FeedbackOrderServlet", urlPatterns = {"/FeedbackOrderServlet"})
public class FeedbackOrderServlet extends HttpServlet {
    private final String ERROR_PAGE = "error.html";
    private final String HISTORY_BIRD_PAIRING = "OrderDetailController";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String idBird = request.getParameter("idBird");
           String idUser = request.getParameter("idUser");
           BirdFeedbackDAO birdFeedbackDAO = new BirdFeedbackDAO();
            boolean result = birdFeedbackDAO.insertBirdFeedBack(idUser, txtFeedback, idBird, rateStarNum);
            if(result) {

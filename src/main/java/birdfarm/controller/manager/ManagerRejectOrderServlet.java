 ...
 * @author HP
 */
@WebServlet(name = "ManagerRejectOrderServlet", urlPatterns = {"/ManagerRejectOrderServlet"})
public class ManagerRejectOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManagerRejectOrderServlet.class.getName()).log(Level.SEVERE, null, ex);

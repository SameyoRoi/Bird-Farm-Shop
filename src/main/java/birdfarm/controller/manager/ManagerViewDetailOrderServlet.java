 ...
 * @author HP
 */
@WebServlet(name = "ManagerViewDetailOrderServlet", urlPatterns = {"/ManagerViewDetailOrderServlet"})
public class ManagerViewDetailOrderServlet extends HttpServlet {

    private final String MANAGER_VIEW_ORDER_PAGE = "Manager_ViewOrderDetail.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (searchVal > 0) {
                ...
                request.setAttribute("ORDER_DETAIL_LIST", result);
                request.setAttribute("ORDER_CUSTOMER_DETAIL_LIST", result1);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManagerViewDetailOrderServlet.class.getName()).log(Level.SEVERE, null, ex);

 ...
 * @author HP
 */
@WebServlet(name = "ManagerSuccessOrderServlet", urlPatterns = {"/ManagerSuccessOrderServlet"})
public class ManagerSuccessOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManagerSuccessOrderServlet.class.getName()).log(Level.SEVERE, null, ex);

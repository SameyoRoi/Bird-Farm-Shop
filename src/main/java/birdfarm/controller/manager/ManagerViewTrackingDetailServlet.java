 ...
 * @author HP
 */
@WebServlet(name = "ManagerViewTrackingDetailServlet", urlPatterns = {"/ManagerViewTrackingDetailServlet"})
public class ManagerViewTrackingDetailServlet extends HttpServlet {

    private final String MANAGER_VIEW_ORDER_PAGE = "Manager_ViewTrackingBirdDetail.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManagerViewTrackingDetailServlet.class.getName()).log(Level.SEVERE, null, ex);

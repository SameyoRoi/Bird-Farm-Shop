 ...
 * @author HP
 */
@WebServlet(name = "ManagerDeleteProductServlet", urlPatterns = {"/ManagerDeleteProductServlet"})
public class ManagerDeleteProductServlet extends HttpServlet {

    private final String MANAGER_VIEW_PRODUCT_PAGE = "Manager_ViewProduct.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("DeleteAccount _ SQL " + ex.getMessage());
        } catch (NamingException ex) {
            log("DeleteAccount _ Naming" + ex.getMessage());
        } finally {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManagerDeleteProductServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

...
public class AdminUpdateAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.updatePassRole(username, password, fullName);
            if (result) {
//                url = "DispatchServlet?btAction=Search&txtSearchValue=" + searchValue;
//                url = MyApplicationConstants.DeleteAccountFeatures.SEARCH_LASTNAME_CONTROLLER
//                        + "?txtSearchValue=" + searchValue;
                  url= "DispatchServlet?btAction=AdminControlAccount";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AdminUpdateAccountServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

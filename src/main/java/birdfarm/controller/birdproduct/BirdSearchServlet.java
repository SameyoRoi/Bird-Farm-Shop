 ...
 * @author ASUS
 */
@WebServlet(name = "BirdSearchServlet", urlPatterns = {"/BirdSearchServlet"})
public class BirdSearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String txtSearch = request.getParameter("txtSearchBird");
            String userID = request.getParameter("userID");
            BirdDAO birdDAO = new BirdDAO();
            birdDAO.searchByName(txtSearch);
            UserDAO userDAO = new UserDAO();
            UserDTO user = userDAO.getUser(userID);
            List<BirdDTO> listSearchBird = birdDAO.getBirdSearchList();
            if(user == null) {
            if(listSearchBird != null) {
            ...
            for(BirdDTO bird: listSearchBird) {

 ...
 * @author Minh
 */
@WebServlet(name = "CheckoutRequiredController", urlPatterns = {"/CheckoutRequiredController"})
public class CheckoutRequiredController extends HttpServlet {

    private static final String SUCCESS = "RcheckOut.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            if (user == null) {
                ...
                RequiredCart checkOutCart = cart;
                ...
                if (cart == null || birdID.equals("")) {
                    ...
                    session.setAttribute("CHECKOUTRCART", checkOutCart);
                    url = SUCCESS;
